...
import {letterFrequency} from "../functions/dataMapper";
...
export const LettersHistogram = () => {
    ...
    function formatData(words: string[]) {
        const allWordsHistogram = letterFrequency(words);
        const fiveLetterWordsHistogram = letterFrequency(fiveLetterWords);
